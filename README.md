...
|            [`latex/`](latex/README.md)            | Complex LaTeX projects (papers, theses, slides) |               latexindent, ChkTeX, latexmk               |
| [`latex_simplified/`](latex_simplified/README.md) |         Simple LaTeX projects (reports)         |               latexindent, ChkTeX, latexmk               |
